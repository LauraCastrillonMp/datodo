...
async function main() {
  ...
  if (dataStructures.length === 0) {
    console.log('❌ No data structures found. Please seed data structures first.');
    return;
  }
  ...
  // Quiz templates for different data structures (slugs en español)
  const quizTemplates: Record<string, any[]> = {
    'pilas': [
      {
        title: 'Fundamentos de Pilas - Básico',
        description: 'Cuestionario básico sobre pilas y sus operaciones fundamentales',
        ...
        questions: [
          ...
          {
            questionText: '¿Qué operación se usa para agregar un elemento a una pila?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué operación se usa para eliminar y retornar el elemento superior de una pila?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la complejidad temporal de las operaciones push() y pop() en una pila?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué estructura de datos se utiliza comúnmente para implementar una pila?',
            questionType: 'multiple_choice' as const,
            options: [
      ...
      },
      {
        ...
        questions: [
          {
            questionText: '¿Cuál de las siguientes es una aplicación común de las pilas?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Evaluación de expresiones matemáticas', isCorrect: true },
          ...
          {
            questionText: '¿Qué algoritmo utiliza pilas para recorrer un árbol?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Para qué se utilizan las pilas en los navegadores web?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué sucede cuando intentas hacer pop() en una pila vacía?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la ventaja principal de usar una pila sobre un array para ciertas operaciones?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Acceso más rápido a cualquier elemento', isCorrect: false },
              { optionText: 'Operaciones de inserción y eliminación más eficientes', isCorrect: true },
    ...
    'colas': [
      {
        ...
        description: 'Cuestionario básico sobre colas y sus operaciones fundamentales',
        difficulty: 'principiante' as const,
        questions: [
          {
          ...
          {
            questionText: '¿Qué operación se usa para agregar un elemento al final de una cola?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'dequeue()', isCorrect: false },
          ...
          {
            questionText: '¿Qué operación se usa para eliminar y retornar el primer elemento de una cola?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'enqueue()', isCorrect: false },
          ...
          {
            questionText: '¿Cuál es la complejidad temporal de las operaciones enqueue() y dequeue() en una cola?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(n)', isCorrect: false },
              { optionText: 'O(1)', isCorrect: true },
          ...
          {
            questionText: '¿Qué estructura de datos se utiliza comúnmente para implementar una cola?',
            questionType: 'multiple_choice' as const,
            options: [
      ...
      },
      {
        ...
        questions: [
          {
            questionText: '¿Cuál de las siguientes es una aplicación común de las colas?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué algoritmo utiliza colas para recorrer un árbol?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Para qué se utilizan las colas en los sistemas operativos?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué sucede cuando intentas hacer dequeue() en una cola vacía?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Se retorna null', isCorrect: false },
              { optionText: 'Se lanza una excepción', isCorrect: true },
          ...
          {
            questionText: '¿Cuál es la diferencia principal entre una cola y una pila?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Una cola usa FIFO, una pila usa LIFO', isCorrect: true },
              { optionText: 'Una cola es más rápida', isCorrect: false },
              { optionText: 'Una pila usa menos memoria', isCorrect: false },
              { optionText: 'Una cola puede tener elementos duplicados', isCorrect: false },
            ],
          },
        ],
      },
        ...
        questions: [
          {
            ...
            options: [
              ...
              { optionText: 'Un valor y un puntero al siguiente nodo', isCorrect: true },
              { optionText: 'Solo un puntero', isCorrect: false },
              { optionText: 'Un array de valores', isCorrect: false },
            ],
          },
          {
            questionText: '¿Cuál es la complejidad temporal para insertar al inicio de una lista enlazada simple?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(n)', isCorrect: false },
              { optionText: 'O(1)', isCorrect: true },
          ...
          {
            questionText: '¿Cuál es la complejidad temporal para buscar un elemento en una lista enlazada simple?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué apunta el último nodo de una lista enlazada simple?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la ventaja principal de una lista enlazada simple sobre un array?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Acceso más rápido a cualquier elemento', isCorrect: false },
              { optionText: 'Inserción y eliminación más eficientes', isCorrect: true },
              { optionText: 'Menor uso de memoria', isCorrect: false },
              { optionText: 'Ordenamiento automático', isCorrect: false },
            ],
          },
        ...
        questions: [
          {
            ...
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Cada nodo tiene punteros al anterior y siguiente', isCorrect: true },
              { optionText: 'Solo tiene punteros hacia adelante', isCorrect: false },
              { optionText: 'El último nodo apunta al primero', isCorrect: false },
              { optionText: 'Tiene múltiples punteros', isCorrect: false },
            ],
          },
          {
            questionText: '¿Cuál es la complejidad temporal para eliminar un nodo en una lista enlazada doble?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Qué ventaja tiene una lista enlazada doble sobre una simple?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la aplicación más común de las listas enlazadas dobles?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Navegadores web (adelante/atrás)', isCorrect: true },
              { optionText: 'Ordenamiento de datos', isCorrect: false },
              { optionText: 'Búsqueda binaria', isCorrect: false },
              { optionText: 'Compresión de datos', isCorrect: false },
            ],
          ...
          {
            questionText: '¿Qué desventaja tiene una lista enlazada doble comparada con una simple?',
            questionType: 'multiple_choice' as const,
            options: [
    ...
    'lista-enlazada-circular': [
      {
        ...
        questions: [
          {
            questionText: '¿Qué característica tiene una lista enlazada circular?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'El último nodo apunta al primero', isCorrect: true },
          ...
          {
            questionText: '¿Cuál es la ventaja principal de una lista enlazada circular?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿En qué aplicación se usa comúnmente una lista enlazada circular?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Planificación de procesos (round-robin)', isCorrect: true },
              { optionText: 'Búsqueda binaria', isCorrect: false },
              { optionText: 'Compresión de datos', isCorrect: false },
          ...
          {
            questionText: '¿Qué apunta el último nodo de una lista enlazada circular?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la complejidad temporal para verificar si una lista es circular?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(1)', isCorrect: true },
              { optionText: 'O(n)', isCorrect: false },
    ...
    'tabla-hash': [
      {
        ...
        questions: [
          ...
          {
            questionText: '¿Cuál es la complejidad temporal promedio para buscar en una tabla hash?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(1)', isCorrect: true },
              { optionText: 'O(n)', isCorrect: false },
          ...
          },
          {
            ...
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Dos claves diferentes producen el mismo hash', isCorrect: true },
          ...
          {
            questionText: '¿Cuál es el peor caso de complejidad temporal para buscar en una tabla hash?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(1)', isCorrect: false },
              { optionText: 'O(n)', isCorrect: true },
      ...
      },
      {
        ...
        description: 'Cuestionario sobre técnicas de manejo de colisiones en tablas hash',
        ...
        questions: [
          ...
          },
          {
            ...
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Buscar la siguiente posición disponible', isCorrect: true },
          ...
          {
            questionText: '¿Cuál es la función de carga (load factor) de una tabla hash?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Número de elementos / tamaño de la tabla', isCorrect: true },
          ...
          },
          {
            ...
            options: [
              ...
              { optionText: 'Los elementos se ordenan automáticamente', isCorrect: false },
            ],
          },
          {
    ...
    'arbol-binario': [
      {
        ...
        questions: [
          {
            questionText: '¿Cuántos hijos puede tener como máximo un nodo en un árbol binario?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es el recorrido en el que se visita primero la raíz, luego el subárbol izquierdo y después el derecho?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          },
          {
            ...
            options: [
              ...
              { optionText: 'Número de niveles desde la raíz hasta la hoja más lejana', isCorrect: true },
              { optionText: 'Número de hojas', isCorrect: false },
              { optionText: 'Número de nodos internos', isCorrect: false },
            ],
          },
          {
            questionText: '¿Cuál es la complejidad temporal para buscar en un árbol binario balanceado?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'O(1)', isCorrect: false },
      ...
      },
      {
        ...
        questions: [
          {
            questionText: '¿Qué característica tiene un árbol binario de búsqueda (BST)?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Los valores del subárbol izquierdo son menores que la raíz', isCorrect: true },
              { optionText: 'Todos los nodos tienen el mismo valor', isCorrect: false },
          ...
          },
          {
            ...
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Todos los niveles están llenos excepto posiblemente el último', isCorrect: true },
              { optionText: 'Todos los nodos tienen dos hijos', isCorrect: false },
              { optionText: 'Solo tiene nodos hoja', isCorrect: false },
              { optionText: 'Es perfectamente balanceado', isCorrect: false },
            ],
          },
          {
            questionText: '¿Cuál es la ventaja de un árbol AVL sobre un BST normal?',
            questionType: 'multiple_choice' as const,
            options: [
              { optionText: 'Se mantiene balanceado automáticamente', isCorrect: true },
          ...
          {
            questionText: '¿Qué recorrido de un BST produce una secuencia ordenada?',
            questionType: 'multiple_choice' as const,
            options: [
          ...
          {
            questionText: '¿Cuál es la aplicación más común de los árboles binarios?',
            questionType: 'multiple_choice' as const,
            options: [
