...
import { Loader2, Code, ArrowLeft, Binary, CheckCircle } from "lucide-react";
      ...
      if (result.error) {
        let errorMsg =
          typeof result.error === "string"
            ? result.error
            : (result.error && result.error.message) || "Error en el registro";
        setError(errorMsg);
        setIsLoading(false);
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-blue-600 items-center justify-center p-8">
        <div className="text-center text-white space-y-6">
          ...
          <p className="text-white/90 w-full max-w-md mx-auto">
